...
name: standup
version: 1.0.0
description: Run a facilitated standup across recently active git worktrees or selected PRs so branch-named agents reconcile changes and produce one consolidation plan.
allowed-tools:
  - Bash
  - Read
  - Edit
